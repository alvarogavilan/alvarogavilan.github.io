...
console.log(JSON.stringify({candidateCount:out.candidateCount,uniqueOosBehaviors,draws:out.draws,maxHits,totalNearFull,totalFull,status:out.status,realMoneyPass:false,realStakeEUR:0},null,2));
