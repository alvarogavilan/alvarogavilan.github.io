...
- **Misión 2 (progressive video poker):** Not executed this pass beyond a repo-wide grep (no hits in the indexed PlayUZU catalog); needs a real per-game audit next pass.
...
- **Misión 7 (loterías con overlay):** Not audited this pass; SELAE roll-down-equivalent search is the concrete next step (see JSON `nextHighestValueActions`).
