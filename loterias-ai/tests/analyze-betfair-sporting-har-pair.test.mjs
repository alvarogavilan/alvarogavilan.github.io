...
const har=(gameTimestamp,amount,winCount=42,casino='bf_es',ght=2000,cacheBust='')=>JSON.stringify({log:{entries:[launcher(),config(casino,cacheBust),ticker(gameTimestamp,amount,winCount,casino,ght)]}});
...
assert.equal(serialized.includes('returnURL='),false);

const generic=analyzeSafeHarPairText(
  genericHar(1990,100),
  genericHar(2005,100.02),
