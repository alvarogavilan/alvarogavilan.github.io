...
const raw=JSON.stringify({log:{entries:[
  {request:{method:'GET',url:'https://launcher.betfair.es/initialResources/es_ES_desktop',headers:[]},response:{status:200,content:{mimeType:'application/json',text:config}}},
  {
...
for(const secret of ['QUERY_SECRET','HEADER_SECRET','SEND_SECRET','RECEIVE_SECRET'])assert.equal(serialized.includes(secret),false);
