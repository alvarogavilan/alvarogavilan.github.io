...
import {extractSportingPublicConfigSignals,discoverPublicAssetUrls,discoverPublicConfigUrls} from '../edge-backend/src/betfair-sporting-public-config-probe-v1.mjs';
...
assert.deepEqual(configs,[
  'https://example.playtech.com/new_jackpotxml.php',
  'https://webtickers.malmegas.com/webtickers',
  'https://launcher.betfair.es/initialResources/es_ES_desktop?foo=1',
]);
