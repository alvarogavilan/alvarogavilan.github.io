...
const cfg={request:{method:'POST',url:'https://game.example/config?token=QUERY_SECRET',headers:[{name:'Authorization',value:'Bearer HEADER_SECRET'}],postData:{mimeType:'application/json',text:'{"betValues":[999],"token":"CLIENT_SECRET"}'}},response:{status:200,content:{mimeType:'application/json',text:JSON.stringify({limits:{minBet:0.01,maxBet:625,betValues:[0.01,0.02,0.05,0.1,0.25],activePaylines:25},token:'RESPONSE_SECRET'})}};
