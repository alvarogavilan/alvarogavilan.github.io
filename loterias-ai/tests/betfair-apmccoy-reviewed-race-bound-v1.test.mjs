...
r=derive({reviewedCycles:[cycle],scheduledAttemptLedgerReview:{...attempt,scheduledAttemptCount:6},actionLatencyReview:latency,raceAssumptionsReview:assumptions,confidence:0.95});
assert.equal(r.reason,'ATTEMPT_LEDGER_REVIEW_COMMIT_NOT_CODE_ALLOWLISTED');
