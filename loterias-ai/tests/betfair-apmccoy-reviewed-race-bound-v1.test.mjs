...
const cycle={version:'betfair-apmccoy-post-ght-survival-review-v1',contractRevision:'v1.1-code-owned-artifact-identity',valid:true,independentReviewApproved:true,completeAttemptLedgerVerified:true,completeObservationHorizon:true,usableForLatencyClassification:true,reviewCommit:fake,reviewArtifactIdentity:'forged-cycle-identity',cycleId:'ap-001',bindingScope:{expectedBetfairImsCasino:'bf_es',tickerEndpoint:'https://ticker.example/new_jackpotxml.php',configSourceUrl:'https://launcher.betfair.es/initialResources/es_ES_desktop',instanceCode:'es1'},requestExecIntervalSeconds:10,detectionTimestamp:100,detectionLagSeconds:0,lastConfirmedUnawardedTimestamp:140,survivalLowerBoundSeconds:40,firstObservedAwardOrResetTimestamp:null,awardResetInterval:null,rightCensored:true};
...
const assumptions={version:'betfair-apmccoy-race-assumptions-review-v1',contractRevision:'v1.2-code-owned-artifact-identity',valid:true,independentRaceAssumptionsReviewed:true,completeProspectiveCycleLedgerVerified:true,binomialSamplingAssumptionJustified:true,currentCycleExchangeabilityVerified:true,samplingWindowFrozenBeforeFirstCycle:true,allEligibleDistinctDailyGhtCyclesIncluded:true,failedShortAndAmbiguousCyclesRetained:true,assumptionsSelectedUsingSurvivalOutcomes:false,reviewCommit:fake,reviewArtifactIdentity:'forged-assumption-identity',protocolId:'race-v1',completeProspectiveLedgerCommit:ledgerCommit,cycleIds:['ap-001'],bindingScopeKey:binding,assumptionEvidenceId:'race-assumptions-v1'};
...
assert.equal(r.version,'betfair-apmccoy-reviewed-race-bound-v1.6-exact-cycle-artifacts');
