...
const lanes=[
  lane('clean-timing-v3','Lightning timing replication — clean V2',timingUsed,timingBoundary,timing?.final?'FIXED_FINAL_AVAILABLE':'BLINDED_ACCUMULATING',{disclosure:timing?.disclosure?.policy||null,outcomePerformanceVisible:timing?.disclosure?.performanceHidden!==true,administrativeEta:timingEta,realMoneyAllowed:false}),
...
const payload={
  ...
  strongestDirectEconomicLane:'clean-lag8-economic-v1',
  ...
  lag8ReplicationPlan:{v2Status:lag8?.final?'FIXED_FINAL_AVAILABLE':'BLINDED_ACCUMULATING',v3PreRegistered:true,v3Status:lag8V3?.state||'WAITING_FOR_LAG8_V2_FIXED_BOUNDARY',v3ActivationIndependentOfV2Outcome:true,postBoundarySampleOnly:true},
  lanes,
