...
//
// Research model: power-law CDF F(q)=q^alpha for the latent drop point over
// normalized interval q in [0,1]. Finite wagers use the EXACT conditional
// probability over the next interval rather than hazard(q)*dq.
