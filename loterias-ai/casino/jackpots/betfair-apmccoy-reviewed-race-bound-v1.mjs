...
export function deriveBetfairApMcCoyReviewedRaceLowerBound({reviewedCycles,scheduledAttemptLedgerReview,actionLatencyReview,raceAssumptionsReview,confidence=0.95}={}){
  ...
  if(!isApprovedBetfairApMcCoyRaceAssumptionReviewArtifact(assumptions))return fail('RACE_ASSUMPTION_REVIEW_ARTIFACT_NOT_CODE_APPROVED',{reviewCommit:assumptions.reviewCommit||null,reviewArtifactIdentity:assumptions.reviewArtifactIdentity||null});
