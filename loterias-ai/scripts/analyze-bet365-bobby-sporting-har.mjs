...
function fail(reason,extra={}){return {version:'bet365-bobby-safe-har-cli-v1',ok:false,reason,...extra,execution:{decision:'NO_PLAY',realMoneyAllowed:false,realStakeEUR:0,maxSpins:0,maxTotalStakeEUR:0}};}
...
export function analyzeSafeBet365BobbyHarText(raw,{sourceName='capture.har'}={}){
  ...
  return {
    version:'bet365-bobby-safe-har-cli-v1',ok:analysis?.valid===true,sourceName,
    ...
    hardGuards:{offlineOnly:true,noNetwork:true,rawHarNeverEmitted:true,requestHeadersNeverEmitted:true,credentialsAndCookiesNeverEmitted:true,endpointQueriesAndFragmentsNeverEmitted:true,analysisCannotAuthorizeGreen:true,noWagerProbe:true,noAutomaticBetting:true},
  };
}
