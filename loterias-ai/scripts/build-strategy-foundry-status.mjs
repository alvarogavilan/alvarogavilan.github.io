...
const defs=[
 ...
 ['temporal-regime-structure','loterias-ai/data/research/mass-regime-structure-search.json','research'],
 ['pair-transition','loterias-ai/data/research/mass-pair-transition-search.json','research'],
 ['pair-triple-novelty','loterias-ai/data/research/novelty-pair-triple-search.json','research'],
 ['gordo-soft-triple-economic','loterias-ai/data/research/gordo-soft-triple-economic-paired.json','financial'],
