...
async function main(){
  ...
  if(!SUPPORTED.has(normGame(game))||!/^\d+$/.test(String(drawId||''))||!archivePath){console.error('Usage: node loterias-ai/scripts/selam-extraction-order-backfill-v1.mjs <primitiva|bonoloto> <drawId> <archive.json>');process.exitCode=2;return;}
