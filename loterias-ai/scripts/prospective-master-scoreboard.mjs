...
for(const f of files){
  ...
  rows.push({file,status,targetDrawDate:target,engine:z.engine||z.sourceEngine||null,sealSHA256:z.sealSHA256||z.full15Hash||z.forecastHash||null,realStakeEUR:stake,realMoneyPass:pass});
}
