...
const daily={
  ...
  bankroll:{opening:Number(bankroll.openingBalance||50),recommendedRealStake:demonstratedEdge?null:0},
  drawsToday,
...
console.log(JSON.stringify({date,draws:drawsToday.length,mode:daily.mode,sources:daily.sources}));