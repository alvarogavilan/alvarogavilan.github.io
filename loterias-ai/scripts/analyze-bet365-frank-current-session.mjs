...
const VERSION='analyze-bet365-frank-current-session-v1';
...
if(args.length!==1)usage();
  ...
  try{
    ...
    const result={
      ...
      execution:execution(),
      hardGuards:{onlineOnly:true,nonPromoOnly:true,localOnly:true,passiveHarOnly:true,noWagerProbe:true,noAutomaticBetting:true,realMoneyAllowed:false},
    };
