...
export function renderBreakthroughs(data,{root=document.getElementById('breakthroughList'),summary=document.getElementById('breakthroughSummary')}={}){
  ...
  if(summary)summary.textContent=cards.length?`${cards.length} HALLAZGOS P0 ONLINE EN ESPAÑA · CONTADORES X/Y = GATES DEL CARRIL, NO % TOTAL EDGE · 0 FÍSICOS · 0 PROMOS · 0 € HASTA CERRAR GATES LOCALES`:'Sin hallazgos P0 online cargados';
